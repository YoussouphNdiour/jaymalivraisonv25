...
class AuthRepo {
  ...
  Future<Response> getWalletPaymentList() async {
    return await apiClient.getData('${AppConstants.walletPaymentListUri}?token=${Get.find<AuthController>().getUserToken()}');
  }

  Future<Response> getWalletProvidedEarningList() async {
    return await apiClient.getData('${AppConstants.walletProvidedEarningListUri}?token=${Get.find<AuthController>().getUserToken()}');
  }
