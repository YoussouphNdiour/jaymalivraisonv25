...
import 'package:sixam_mart_delivery/data/model/response/disbursement_method_model.dart';
import 'package:sixam_mart_delivery/helper/route_helper.dart';
import 'package:sixam_mart_delivery/util/dimensions.dart';
import 'package:sixam_mart_delivery/util/styles.dart';
import 'package:sixam_mart_delivery/view/base/custom_app_bar.dart';
import 'package:sixam_mart_delivery/view/screens/disbursements/widget/confirm_dialog.dart';
import 'package:sixam_mart_delivery/view/screens/disbursements/widget/withdraw_method_attention_dialog.dart';
...
class _WithdrawMethodScreenState extends State<WithdrawMethodScreen> {
  ...
  initCall() async {
    ...
    bool warningMessage = widget.isFromDashboard ? false : await Get.find<DisbursementController>().disbursementWarningMessage();
    if (warningMessage) {
      Get.dialog(
        Dialog(
          ...
          //this right here
          child: const WithdrawMethodAttentionDialog(isFromDashboard: false),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'disbursement_methods'.tr),
