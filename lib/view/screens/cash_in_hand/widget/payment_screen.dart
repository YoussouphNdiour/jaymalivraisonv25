...
import 'package:sixam_mart_delivery/view/screens/cash_in_hand/widget/fund_payment_dialog.dart';

class PaymentScreen extends StatefulWidget {
  final String? redirectUrl;
  const PaymentScreen({Key? key, this.redirectUrl}) : super(key: key);
